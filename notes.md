...
### Experiment 0: Previous baseline (before this session)
- **Config**: Default 9L/512dim/1024vocab, 30min, 65K batch
- **Result**: roundtrip_val_bpb=3.24274821, artifact=5.34MB — only 67 steps ran (likely throughput issue with old config)
- **Note**: This was a very early run with poor throughput. Need a proper baseline.
