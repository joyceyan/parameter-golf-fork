...
class Hyperparameters:
    ...
    tied_embed_lr: float = float(os.environ.get("TIED_EMBED_LR", 0.50))
    matrix_lr: float = float(os.environ.get("MATRIX_LR", 0.40))
    scalar_lr: float = float(os.environ.get("SCALAR_LR", 0.40))
